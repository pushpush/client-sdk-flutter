...
import 'package:flutter/services.dart' show EventChannel, MethodChannel, MethodCall, MissingPluginException, PlatformException;
...
class Native {
  ...
  @internal
  static const EventChannel androidAudioDevicesEventChannel =
      EventChannel('livekit_client/android_audio_devices');
